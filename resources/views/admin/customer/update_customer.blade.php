                    ...
                    <div class="active tab-pane" id="activity">
                      <form class="form-horizontal" action="{{ route('customer#update') }}" method="post">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="hidden" class="form-control" name="id" value="{{ $customer->customer_id }}">
                            <input type="text" class="form-control" placeholder="Name" name="name" value="{{ $customer->customer_name }}">
                          </div>
                        </div>
